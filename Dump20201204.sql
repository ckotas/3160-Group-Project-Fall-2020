...
CREATE TABLE `ratingsystem` (
  ...
  CONSTRAINT `DriverID` FOREIGN KEY (`driver_id`) REFERENCES `driver` (`driver_id`),
...
-- Dump completed on 2020-12-04 12:23:11
