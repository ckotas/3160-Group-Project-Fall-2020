...
CREATE TABLE `ratingsystem` (
  ...
  `rating_r` int DEFAULT NULL,
  `rating_d` int DEFAULT NULL,
...
LOCK TABLES `ratingsystem` WRITE;
/*!40000 ALTER TABLE `ratingsystem` DISABLE KEYS */;
INSERT INTO `ratingsystem` VALUES (1,1,2,5,10,10),(2,3,1,2,5,6),(3,5,3,2,9,6),(4,3,2,4,8,6),(5,3,3,2,2,3),(6,5,5,1,3,4),(7,4,5,4,3,9),(8,5,4,4,8,6),(9,4,3,4,6,4),(10,2,2,1,4,5),(11,3,2,1,2,3),(12,1,2,1,4,5),(13,4,5,5,1,10),(14,1,4,2,1,2),(15,4,3,5,7,7),(16,2,5,2,4,6),(17,2,1,1,4,10),(18,3,1,2,4,2),(19,5,4,4,2,3),(20,5,3,5,1,6),(21,2,3,1,4,10),(22,3,3,1,4,3),(23,3,1,4,8,5),(24,3,1,4,10,5),(25,4,3,4,3,2),(26,1,1,2,9,4),(27,5,3,4,1,6),(28,4,2,1,3,3),(29,5,5,2,1,1),(30,3,3,2,9,10),(31,1,2,5,6,7),(32,3,4,5,5,8),(33,4,1,4,6,1),(34,2,3,5,3,3),(35,4,5,1,5,9),(36,3,2,2,2,1),(37,1,4,4,9,3),(38,5,5,1,4,8),(39,2,4,4,2,1),(40,2,5,4,2,9),(41,1,5,1,2,8),(42,5,1,3,3,5),(43,4,1,2,8,6),(44,5,3,4,6,9),(45,3,1,2,10,10),(46,1,5,1,1,9),(47,1,5,1,6,4),(48,3,1,3,10,8),(49,1,2,2,3,6),(50,5,5,5,8,3),(51,2,1,1,3,3),(52,4,3,5,8,10),(53,1,5,2,3,6),(54,4,3,1,6,1),(55,1,3,1,1,7),(56,3,3,1,1,9),(57,5,3,2,4,6),(58,5,4,2,5,9),(59,1,3,2,7,6),(60,5,5,3,2,7),(61,5,5,1,1,3),(62,1,4,1,6,9),(63,4,5,3,6,6),(64,4,1,2,3,3),(65,2,3,2,3,5),(66,1,3,4,2,9),(67,5,2,1,5,3),(68,2,5,1,4,3),(69,2,1,2,2,10),(70,2,2,4,2,3),(71,2,4,5,6,5),(72,5,2,4,2,8),(73,3,1,2,7,6),(74,1,4,2,3,10),(75,1,1,5,1,6),(76,2,5,3,4,5),(77,2,2,3,8,7),(78,1,1,3,1,10),(79,1,1,5,5,6),(80,1,3,2,3,9),(81,5,5,5,4,2),(82,1,5,1,3,3),(83,2,1,5,1,8),(84,3,1,3,2,1),(85,3,2,3,1,9),(86,4,1,2,4,8),(87,3,5,1,1,7),(88,3,1,1,1,6),(89,4,4,4,6,7),(90,2,4,3,8,3),(91,1,4,4,7,5),(92,1,5,5,8,10),(93,1,4,5,3,4),(94,3,3,2,10,9),(95,5,4,2,5,8),(96,5,5,3,1,10),(97,1,4,3,4,5),(98,5,2,3,3,10),(99,1,5,3,6,7),(100,3,2,1,3,1);
/*!40000 ALTER TABLE `ratingsystem` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `countOfDriverRatingOver5` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `countOfDriverRatingOver5`()
BEGIN
SELECT 
distinct count(ratingsystem.rating_d ) OVER (partition by ratingsystem.driver_id) as rating_over_5,  person.person_name
FROM campus_eats_fall2020.ratingsystem
INNER JOIN campus_eats_fall2020.driver ON ratingsystem.driver_id = driver.driver_id
INNER JOIN campus_eats_fall2020.student ON driver.student_id = student.student_id
INNER JOIN campus_eats_fall2020.person ON student.person_id = person.person_id
Where ratingsystem.rating_d >5
order by rating_over_5 desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `driver_average_asc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `driver_average_asc`()
BEGIN
SELECT DISTINCT driver_id, AVG(rating_d) OVER (partition by driver_id) as AVERAGE_DRIVER
FROM campus_eats_fall2020.ratingsystem
order by AVERAGE_DRIVER ASC;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `driver_average_desc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `driver_average_desc`()
BEGIN
SELECT DISTINCT driver_id, AVG(rating_d) OVER (partition by driver_id) as AVERAGE_DRIVER
FROM campus_eats_fall2020.ratingsystem
order by AVERAGE_DRIVER DESC;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `driver_MAX` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `driver_MAX`()
BEGIN
SELECT DISTINCT driver_id, MAX(rating_d) OVER (partition by driver_id) as Max_DRIVER
FROM campus_eats_fall2020.ratingsystem
order by MAX_DRIVER desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `driver_Min` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `driver_Min`()
BEGIN
SELECT DISTINCT driver_id, MIN(rating_d) OVER (partition by driver_id) as MIN_DRIVER
FROM campus_eats_fall2020.ratingsystem
order by MIN_DRIVER desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `restaurant_avg_asc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_avg_asc`()
BEGIN
SELECT DISTINCT restaurant_id, AVG(rating_r) OVER (partition by restaurant_id) as AVERAGE_RESTAURANT
FROM campus_eats_fall2020.ratingsystem
Order by AVERAGE_RESTAURANT asc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `restaurant_avg_desc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_avg_desc`()
BEGIN
SELECT DISTINCT restaurant_id, AVG(rating_r) OVER (partition by restaurant_id) as AVERAGE_RESTAURANT
FROM campus_eats_fall2020.ratingsystem
Order by AVERAGE_RESTAURANT desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `restaurant_MAX` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_MAX`()
BEGIN
SELECT DISTINCT restaurant_id, MAX(rating_r) OVER (partition by restaurant_id) as MAX_RESTAURANT
FROM campus_eats_fall2020.ratingsystem
Order by MAX_RESTAURANT desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `restaurant_MIN` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_MIN`()
BEGIN
SELECT DISTINCT restaurant_id, MIN(rating_r) OVER (partition by restaurant_id) as MIN_RESTAURANT
FROM campus_eats_fall2020.ratingsystem
Order by MIN_RESTAURANT desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `review_over_7` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `review_over_7`()
BEGIN
SELECT Distinct count(rating_r) OVER (partition by ratingsystem.restaurant_id) as review_over_7, restaurant.location, restaurant.restaurant_name, restaurant.schedule, restaurant.website
FROM campus_eats_fall2020.ratingsystem
INNER JOIN campus_eats_fall2020.restaurant
ON ratingsystem.restaurant_id = restaurant.restaurant_id
Where  ratingsystem.rating_r > 7
Order by  review_over_7 desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2020-12-14 12:35:40
